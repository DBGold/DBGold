...
const string strMessageMagic = "DBGold Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DBGold", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Chinese bank buys secret London vault which can store 80bn of gold";
        CTransaction txNew;
        txNew.nTime = 1463942862;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1463942862;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 76155 : 0;



        //// Debug print
        assert(block.hashMerkleRoot == uint256("0x5c3bed21b097e499fbfc8ac5f56900878ebb247068c08127c2468aea009ed551"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x04, 0xa1, 0xb1, 0xb5 };
